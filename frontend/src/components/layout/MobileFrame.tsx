...
function DesktopBackdrop() {
  return (
    <div className="desktop-backdrop" aria-hidden>
      ...
      <svg className="desktop-backdrop__mountains" viewBox="0 0 1440 320" preserveAspectRatio="none">
        <path
      ...
      <div className="desktop-backdrop__trees">
        {[...Array(12)].map((_, i) => (
          <span key={i} className="desktop-backdrop__tree" style={{ left: `${5 + i * 8}%` }} />
        ))}
      </div>
      <div className="desktop-brand hidden lg:block">
        <p className="desktop-brand__tag">WEEKEND WARRIORS</p>
